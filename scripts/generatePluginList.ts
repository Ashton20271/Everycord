...
(async () => {
    ...
    const everycordFlag = args.includes("--everycord");
    ...
    if (equicordFlag) {
    ...
    } else if (everycordFlag) {
        dirs = ["src/everycordplugins/_core", "src/everycordplugins"];
    } else if (vencordFlag) {
        ...
        dirs = [
            ...
            "src/everycordplugins/_core", "src/everycordplugins",
