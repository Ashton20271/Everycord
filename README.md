...
| Feature | Description |
|---|---|
| 1269 plugin source folders | Combines Vencord, Equicord, TestCord, Illegalcord, MallCord, Equicord+, Esharq, and OpenCord plugins. |
| About 845 visible plugins | Approximates the desktop in-app settings list; it can be lower because source folders include duplicate names, API/core helpers, and platform or dev-targeted entries filtered out at build time. |
...
| TestCord | 420 | [TestcordDev/TestCord](https://github.com/TestcordDev/TestCord) |
| Illegalcord | 79 | [ImHisako/Illegalcord](https://github.com/ImHisako/Illegalcord) |
| MallCord | 270 | [MallCord/MallCord](https://github.com/MallCord/MallCord) |
| Equicord+ | 17 | [Chaython/EquicordPlus](https://github.com/Chaython/EquicordPlus) |
| Esharq | 116 | [LOSTSTR/Esharq](https://github.com/LOSTSTR/Esharq) |
...
src/everycordplugins/         OpenCord plugins
```
